...
all_my_packages <- c(
  "tidyverse", "corrplot", "VIM", "Hmisc", "psych",
  "plotly", "GGally", "mice", "patchwork",
  "ggcorrplot", "gridExtra", "RColorBrewer", "scales"
)

missing <- all_my_packages[
  !(all_my_packages %in% installed.packages()[, "Package"])
]
